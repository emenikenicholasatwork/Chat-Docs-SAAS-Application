    ...
    <>
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          Chat Docs allows you to have conversations with any PDF document. Simply uplaod your files and start asking questions right away.
        </p>
        ...
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Chatting with you pdf files has never been easier with Chat Doc.
            </p>
          </div>
        </div>

        <ol className="my-8 spacey-4 pt-8 md:flex 
        md:space-x-12 md:space-y-0">
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-1-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="mt-2 text-zinc-700">
                It&apos;s that simple. Try out Chat Doc today - it really takes less than a minutes.
              </span>
            </div>
          </li>
        </ol>
